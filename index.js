...
app.post("/submit", (req, res) => {
  ...
  const randAdj = adj[Math.floor(Math.random() * adj.length)]; // Picking a random adjective from array of adjectives
  const randNoun = noun[Math.floor(Math.random() * noun.length)]; // Picking a random noun from array of nouns
